...
def img2tensor(img, bgr2rgb=True, float32=True):
    """HWC BGR uint8/float image -> CHW RGB tensor.

    Inlined from BasicSR (`basicsr.utils.img2tensor`, Apache-2.0) so this
    release does not have to vendor the whole BasicSR package for one helper.
    """
